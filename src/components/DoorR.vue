    ...
    methods: {
      ...
      sendData(){
        if (this.switch1 == true) {
          this.acciones.push({actionName: "open", props: []});
        } else {
          this.acciones.push({actionName: "close", props: []});
        }

        if (this.switch2 == true) {
          this.acciones.push({actionName: "lock", props: []});
        } else {
          this.acciones.push({actionName: "unlock", props: []});
        }
